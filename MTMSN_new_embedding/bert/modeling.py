...
class BERTEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        self.type_embeddings = nn.Embedding(19+1, config.hidden_size)
        # self.LayerNorm is not snake-cased to stick with TensorFlow model variable name and be able to load
        # any TensorFlow checkpoint file
        self.LayerNorm = BERTLayerNorm(config)
        self.dropout = nn.Dropout(config.hidden_dropout_prob)

    def forward(self, input_ids, type_ids, token_type_ids=None):
        ...
        embeddings = words_embeddings + position_embeddings + token_type_embeddings + type_embeddings
...
class BertModel(nn.Module):
    ...
    def forward(self, input_ids, type_ids=None, token_type_ids=None, attention_mask=None):
        ...
        embedding_output = self.embeddings(input_ids, type_ids, token_type_ids)
